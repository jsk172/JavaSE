 ...
 *  변수는 이름을 통해 해당 메몰 공간에 접근하고 값을 읽거나 수정할 수 있다.
 *  
 * 변수 선언 및 초기화
...
public class Var {
	int globalNum = 100;
	static int globalNum2; // 변수 선언 초기화 하지않음.
	
	public static void main(String[] args) {
		int areaNum2; //변수 선언 초기화 하지않음.
